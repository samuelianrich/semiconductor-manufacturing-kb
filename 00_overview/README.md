# Orientation and physical chain

Status: **Architecture only — technical articles have not been researched or drafted.**

Module `M00` · Build phase 0 · [Topic inventory](../catalog/topic_inventory.md) · [Graph](../DEPENDENCIES.md)
...
[Raw materials](../01_raw_materials/README.md), [Semiconductor physics](../05_semiconductor_physics/README.md), [Historical transitions](../39_history/README.md)

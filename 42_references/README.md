...
Status: **Phase 1–3 reference content available; later coverage remains planned.**
...
None; this is an entry point or reference resource.
...
[Bibliography](bibliography.md) · [Company claims](claims.csv) · [Research queue](research_queue.md) · [Phase 1 source review](papers/phase1_source_review.md)
...
[Phase 3 source locator index](phase3_source_index.json) · [Phase 3 audit](../AUDIT_PHASE3.md).
